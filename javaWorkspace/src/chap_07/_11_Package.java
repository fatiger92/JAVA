...
public class _11_Package {
    public static void main(String[] args) {
        ...
        //System.out.println("랜덤 실수 (범위) : " + random.nextDouble()); // 범위 지정 불가
